...
curl -sSL https://raw.githubusercontent.com/fniessen/shell-leuven-new/master/rc-common-settings-shell-leuven-new | bash

# Load Bash-specific settings.
curl -sSL https://raw.githubusercontent.com/fniessen/shell-leuven-new/master/rc-bash-specific-settings-shell-leuven-new | bash
#+end_src
...
#+begin_src shell :tangle no
# Load common settings.
curl -sSL https://raw.githubusercontent.com/fniessen/shell-leuven-new/master/rc-common-settings-shell-leuven-new | zsh

# Load Zsh-specific settings.
curl -sSL https://raw.githubusercontent.com/fniessen/shell-leuven-new/master/rc-zsh-specific-settings-shell-leuven-new | zsh
#+end_src
